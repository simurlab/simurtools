% CARGAR_DATOS_XSENS Leer un archivo de los xsens del tipo .txt
%
% Syntax: 
...
%
% Examples:
%   medicion=cargar_datos_xsens('00500686-xsens.txt','walkFOOT')
%
...
function [medicion] = carga_datos_xsens(filename, idname, startRow, endRow)
