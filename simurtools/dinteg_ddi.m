% DINTEG_DDI   Realiza la doble integral de una aceleracion mediante el metodo DDI, 
...
% 
% Syntax: pos=dinteg_ddi(acc,freq)
% 
% Input parameters:
...
% Examples: 
%
% See also: dinteg_lri, dinteg_msi, dinteg_ofi, dinteg_cms

% Author:   Diego
% History:  renaming, JC 30-11-2019


function pos=dinteg_ddi(acc,freq)
